...
/**
 * Bark compatible endpoint for format with title and subtitle: /:key/:title/:subtitle/:body
 *
 * This endpoint handles the Bark format with title and subtitle
 *
 * Query parameters:
...
export const GET: APIRoute = async ({ params, request, locals }) => {
  try {
    ...
    // For this endpoint, we handle the /:key/:title/:subtitle/:body format
    // The title and subtitle are already extracted from the URL params
